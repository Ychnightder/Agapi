...
//
//        if (connecter) {
//            // Rendre visible le conteneur et ajouter les boutons dynamiquement
//            loginButtonsContainer.setVisibility(View.VISIBLE);
//            if (loginButtonsContainer.getChildCount() == 0) { // Éviter d'ajouter plusieurs fois
//                View buttonsView = getLayoutInflater().inflate(R.layout.accueil_2buttons, loginButtonsContainer, false);
//                loginButtonsContainer.addView(buttonsView);
//            }
//
//            // Gérer les boutons
//            Button buttonPourvous = findViewById(R.id.buttonPourVous);
//            Button buttonSuivies = findViewById(R.id.buttonSuivies);
//            View viewPourvous = findViewById(R.id.barButton_Pourvous);
//            View viewSuivies = findViewById(R.id.barButton_Suivis);
//
...
//
//        } else {
//            // Supprimer le contenu et cacher l'espace
