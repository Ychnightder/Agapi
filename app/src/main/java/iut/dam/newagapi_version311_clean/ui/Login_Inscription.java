...
public class Login_Inscription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // titre app
        buttonInscriptionTitre = findViewById(R.id.titleInscription);
        buttonConnectionTitre = findViewById(R.id.titlebuttonConnexion);
        ...
        buttonInscriptionTitre.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        buttonConnectionTitre.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d("DEBUG", "Inscription button clicked!");
                getSupportFragmentManager().beginTransaction()
